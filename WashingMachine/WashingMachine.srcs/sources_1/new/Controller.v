...
module controller(
    ...
    wire clk_clock,clk_reset,power_state, pause_state,finished,dududu;
    wire running_state,clk_second,clk_minite,
            done_second,done_process,done_total,
            reset_second,reset_process,reset_total;
    wire [2:0]weight_state,wrd_state;
    wire [4:0]process_running;
	wire [7:0]load_process_time,total_remain,process_remain,second_remain;

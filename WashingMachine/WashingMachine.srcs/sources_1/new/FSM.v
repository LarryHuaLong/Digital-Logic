module fsm(
    ...
    down_counter c_second(clk_second,reset_second,8'b00111010,clk_min,second_remain);//秒钟计时器
	...
	initial begin 
		   ...
		   process_remain <= weight_state;//排水时间
           end
	...
	always @(posedge mode)
	   ...
	   case(mode_state)
			mode1:begin mode_state <= mode2;//切换到单洗模式
					   ...
					   process_state <= process0;
					   process_remain <= weight_state;//进水时间
				   end
